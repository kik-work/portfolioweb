...
export const CVChatModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    ...
    const handleBadgeClick = (badge: string) => {
        // 1️⃣ Add badge as a user message
        setMessages((prev) => [...prev, { sender: "user", text: badge }]);

        // 2️⃣ Prepare bot response text
        let botText = "";
        ...
        // 3️⃣ Show typing indicator and then bot response
    ...
    return (
        ...
        "
            >
                ...
                {/* Header */}
                <DialogHeader className="flex flex-row justify-between items-center mb-3 border-b border-muted pb-2">
                    <DialogTitle className="flex items-center gap-2">
                        <TypographyH4> CV Chat Assistant </TypographyH4> <Bot className="text-primary" />
                    </DialogTitle>
