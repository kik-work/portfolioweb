...
export const SKILL_TABS: SkillTab[] = [
  {
    ...
    icon: Languages,
    skills: [
      { name: "JavaScript", icon: "/javascript.svg", level: "Advanced", rating: 8.7 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Next.js", icon: "/nextjs.Default", level: "Advanced", rating: 8 },
      { name: "Express", icon: "/express.png", level: "Advanced", rating: 8 },
      { name: "Laravel", icon: "/laravel.png", level: "Intermediate", rating: 7 },
  ...
  },
  {
    ...
    icon: Grid2X2Check,
    skills: [
      { name: "Firebase", icon: "/firebase-1.svg", level: "Advanced", rating: 8 },
      { name: "Node.js", icon: "/nodejs.svg", level: "Advanced", rating: 8 },
      { name: "Redux", icon: "/redux.svg", level: "Intermediate", rating: 7 },
      { name: "Prisma", icon: "/prisma-2.svg", level: "Intermediate", rating: 7 },
  ...
  },
  {
    ...
    icon: Database,
    skills: [
      { name: "PostgreSQL", icon: "/postgresql.svg", level: "Advanced", rating: 8 },
      { name: "MySQL", icon: "/mysql-3.svg", level: "Intermediate", rating: 7 },
      { name: "MongoDB", icon: "/mongodb.svg", level: "Intermediate", rating: 6 },
    ],
  },
  {
    id: "tools",
    ...
    skills: [
      ...
      { name: "Postman", icon: "/postman.svg", level: "Intermediate", rating: 7 },
      { name: "Visual Studio", icon: "/visual-studio-2013.svg", level: "Intermediate", rating: 7 },
    ],
  },
];
